"""
GMAX NOTÍCIAS — Coletor de Notícias Locais de São Paulo
Scraping da Prefeitura, Câmara, ALESP e Governo SP
"""
...
logger = logging.getLogger('gmaxnoticias.coletor_sp')
...
def coletar_todas_sp():
    ...
    logger.info(f"Total de notícias coletadas de São Paulo: {len(todas)}")
    return todas
