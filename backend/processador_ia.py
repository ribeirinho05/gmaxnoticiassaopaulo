"""
GMAX NOTÍCIAS — Processador IA (Google Gemini 2.5 Flash via HTTP direto)
...
logger = logging.getLogger('gmaxnoticias.processador_ia')
...
def gerar_trending_topics(noticias, model=None):
    ...
    return ['#GMAXNoticias', '#SãoPaulo', '#Brasil', '#Economia', '#Política', '#Esportes']
