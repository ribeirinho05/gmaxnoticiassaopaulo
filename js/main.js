...
(function() {
    ...
    function initHero() {
        ...
        repSlide.innerHTML = '<div class="hero-rep-split">' +
            ...
            '<span class="hero-slide-badge" style="background:#E63946">Reportagem Especial</span>' +
            ...
            '<span class="hero-slide-meta">Redação GMAX &bull; Reportagem</span>' +
            '</div></div>';
    ...
    function renderCards() {
        ...
        var repCard = curCat === 'todas' ? '<div class="card-h card-h-rep" onclick="window.location.href=\'reportagem-quantagropharma.html\'">' +
            ...
            '<div class="card-h-meta"><span class="author">Redação GMAX</span><span>Reportagem</span></div>' +
            '</div></div>' : '';
